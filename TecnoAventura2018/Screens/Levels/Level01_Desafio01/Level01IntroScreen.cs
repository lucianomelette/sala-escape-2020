...
{
    public partial class Level01IntroScreen : LevelScreen
    {
        private String uriAudio = "level01_intro.mp3";
        private Bitmap levelTitle = Resources.level01_desafio;
        private Bitmap nextBackground = Resources.level01_intro_next_bg;

        private Panel playButton;
        private Panel nextButton;

        public Level01IntroScreen(BoardScreen board) : base(board)
        {
            InitializeComponent();
        }

        private void Level01IntroScreen_Load(object sender, EventArgs e)
        {
            Init();
        }
        ...
        {
            board.SetLevelScreen(new Level01CompleteWordsScreen(board));
        }

...
{
    public partial class Level05Question01Screen : LevelScreen
    {
        private Panel _okPanel;
        private Panel _errorPanel;
        private Panel _closeButton;

        public Level05Question01Screen(BoardScreen board) : base(board)
        {
            InitializeComponent();
        }

        private void Level05Question01Screen_Load(object sender, EventArgs e)
        {
            Init();
        }
        ...
        private void Level05Question01Screen_Click(object sender, EventArgs e)
        {
        ...
        private void CorrectAnswer(object sender, EventArgs e)
        {
            ...
            BackgroundImage = Resources.level05_popup01;

            _closeButton = new Panel();
            _closeButton.Click += (s1, e1) =>
            {
                board.SetLevelScreen(new Level05Question02Screen(board));
            };

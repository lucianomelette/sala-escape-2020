...
{
    public partial class Level05Question03Screen : LevelScreen
    {
        private Panel _okPanel;
        private Panel _errorPanel;
        private Panel _closeButton;

        public Level05Question03Screen(BoardScreen board) : base(board)
        {
            InitializeComponent();
        }

        private void Level05Question03Screen_Load(object sender, EventArgs e)
        {
            Init();
        }
        ...
        private void CorrectAnswer(object sender, EventArgs e)
        {
            ...
            BackgroundImage = Resources.level05_popup03;

            _closeButton = new Panel();
            _closeButton.Click += (s1, e1) =>
            {
                board.SetLevelScreen(new Level05Question04Screen(board));
            };
        ...
        private void setupCloseButton()
        {
            ...
            _closeButton.Left = (int)(Width * 0.83);
            _closeButton.Top = (int)(Height * 0.357);
            //_closeButton.BorderStyle = BorderStyle.FixedSingle;
            _closeButton.BackColor = Color.Transparent;
            _closeButton.BringToFront();
        }

        private void Level05Question03Screen_Click(object sender, EventArgs e)
        {
            //setupCloseButton();
        }
